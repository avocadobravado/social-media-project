...
namespace SocialMedia.Objects
{
  public class Status
  {
    ...
    public void Like()
    {
      ...
      SqlCommand cmd = new SqlCommand("UPDATE statuses SET likes = @Likes OUTPUT INSERTED.likes WHERE id = @StatusId;", conn);
    ...
    public void Dislike()
    {
      ...
      SqlCommand cmd = new SqlCommand("UPDATE statuses SET dislikes = @Likes OUTPUT INSERTED.dislikes WHERE id = @StatusId;", conn);
